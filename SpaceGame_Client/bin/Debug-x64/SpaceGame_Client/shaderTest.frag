...
void main()
{
	vec4 textureColor = getTextureColor(int(v_TexIndex));
	color = textureColor; return;
...
vec4 getTextureColor(int index){
	...
	// Get the specified color and textures color from texture at index 0.
	if(index == 0) end_color = texture(u_Textures[0], v_TexCoord) * v_Color;
	else if(index == 1) end_color = texture(u_Textures[1], v_TexCoord) * v_Color;
	else if(index == 2) end_color = texture(u_Textures[2], v_TexCoord) * v_Color;
	else if(index == 3) end_color = texture(u_Textures[3], v_TexCoord) * v_Color;
	else if(index == 4) end_color = texture(u_Textures[4], v_TexCoord) * v_Color;
	else if(index == 5) end_color = texture(u_Textures[5], v_TexCoord) * v_Color;
	else if(index == 6) end_color = texture(u_Textures[6], v_TexCoord) * v_Color;
	else if(index == 7) end_color = texture(u_Textures[7], v_TexCoord) * v_Color;
	else if(index == 8) end_color = texture(u_Textures[8], v_TexCoord) * v_Color;
	else if(index == 9) end_color = texture(u_Textures[9], v_TexCoord) * v_Color;
	else if(index == 10) end_color = texture(u_Textures[10], v_TexCoord) * v_Color;
	else if(index == 11) end_color = texture(u_Textures[11], v_TexCoord) * v_Color;
	else if(index == 12) end_color = texture(u_Textures[12], v_TexCoord) * v_Color;
	else if(index == 13) end_color = texture(u_Textures[13], v_TexCoord) * v_Color;
	else if(index == 14) end_color = texture(u_Textures[14], v_TexCoord) * v_Color;
	else if(index == 15) end_color = texture(u_Textures[15], v_TexCoord) * v_Color;
	else if(index == 16) end_color = texture(u_Textures[16], v_TexCoord) * v_Color;
	else if(index == 17) end_color = texture(u_Textures[17], v_TexCoord) * v_Color;
	else if(index == 18) end_color = texture(u_Textures[18], v_TexCoord) * v_Color;
	else if(index == 19) end_color = texture(u_Textures[19], v_TexCoord) * v_Color;
	else if(index == 20) end_color = texture(u_Textures[20], v_TexCoord) * v_Color;
